#include "lab20.h" // [Missing Code 1] Include header file
...
int main(){
    ...
    Equipment armor(25, -2, 2); // [Missing Code 2] Create Equipment 
    ...
    else if(eq == '4') hero.equip(&armor); // [Missing Code 3] Equip selected equipment
